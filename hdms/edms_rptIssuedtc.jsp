...
<center>
<font color="black" size="5" >Issue Details[Any Date]</font>
</center>
<br><br><br>
<form name="f1" action="edms_rptIssuedts.jsp" method="get">
...
<select name="cmbdate" class="ovalstyle">
	...
	try{
		...
		rsdt=stmtFilldt.executeQuery("select * from edms_tblissue");
		while(rsdt.next()){
			dt=rsdt.getString("invoicedate");
			%>
