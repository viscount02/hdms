...
<%!
Connection conn;
Statement stmtFillvn,stmtFillArray;
ResultSet rsvn,rsArray;
String vn;
int i;
...
<center>
<font color="black" size="5" >Purchase Detail[Any vehicle]</font>
</center>
<br><br><br>
<form name="f1" action="edms_rptPurvehicles.jsp" method="get">
...
<select name="cmbvname" class="ovalstyle">
	...
	doConnect();
	try{
		stmtFillvn=conn.createStatement();
		rsvn=stmtFillvn.executeQuery("select * from edms_tblpurvehicle");
		while(rsvn.next()){
			vn=rsvn.getString("vname");
			%>
