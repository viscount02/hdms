...
<center>
<font color="black" size="5" >Vehicle Details [Any Vehicle]</font>
</center>
<br><br><br>
<form name="f1" action="edms_rptVehicleVehicles.jsp" method="get">
...
<td><select name="cmbvname" class="ovalstyle">
